...
export default function ReportModal({ isOpen, onClose, apiType = 'project', quarters = [] }) {
    ...
    const handleExportExcel = () => {
        ...
        XLSX.utils.book_append_sheet(wb, wsData, apiType === 'daily' ? 'Activity & Edge Ops' : (apiType === 'wo' ? 'Work Orders' : 'Projects'));
    ...
    const handlePrint = () => {
        ...
        printWindow.document.write(`
            ...
            <html>
            <head>
                <title>Report - ${apiType === 'daily' ? 'Activity & Edge Ops' : (apiType === 'wo' ? 'Work Order' : 'Project')}</title>
                        ...
                        {loading ? (
                            ...
                            <div className="p-8">
                                <div className="report-header text-center border-b-[3px] border-[#ff5757] pb-6 mb-8">
                                    <h1 className="text-2xl font-bold text-[#1a1a2e] mb-1 tracking-wide">{apiType === 'daily' ? 'ACTIVITY INFRASTRUCTURE & EDGE OPERATIONS' : (apiType === 'wo' ? 'WORK ORDER' : 'PROJECT')} INFRASTRUCTURE ENGINEER</h1>
                                ...
                                <div className="mt-12 pt-6 border-t border-ch-soft text-center">
                                    <p className="text-xs text-ch-primary">Activity Infrastructure & Edge Operations - Report generated by system</p>
                                </div>
                            </div>
                        ) : (
                            <div className="flex flex-col items-center justify-center h-[400px] text-ch-primary">
